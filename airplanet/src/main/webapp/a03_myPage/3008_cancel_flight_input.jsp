	...
	<%@ include file="/header_logout.html" %>
		...
		<div class="row no-gutters">
			...
			<div class="col-3 mt-5 bg-secondary bg-opacity-50">
				...
				<button style="margin-top:30px;font-size:30px;float:right;width:95%;height:60px;background:steelblue;border:none;color:white;border-radius:12px;" class="btn me-md-2" type="button">요청하기</button>
			</div>
			<div class="col-1"></div>
			...
			<div class="col-md-3 mt-4 offset-md-1">
				<div><h2><b>2. 취소할 부가서비스 선택</b></h2></div>
				<div class="form-check form-check-inline">
					<input style="zoom:1.3;margin-left:10px;margin-top:10px;" class="form-check-input" type="checkbox" id="inlineCheckbox1" value="option1">
					<label style="font-size:20px;margin-top:10px;" class="form-check-label" for="inlineCheckbox1">수화물 추가(탑승객1)</label>
				</div>
				<div class="form-check form-check-inline">
					<input style="zoom:1.3;margin-left:10px;margin-top:10px;" class="form-check-input" type="checkbox" id="inlineCheckbox2" value="option2">
					<label style="font-size:20px;margin-top:10px;" class="form-check-label" for="inlineCheckbox2">수화물 추가(탑승객2)</label>
				</div>
			</div>
			<div class="w-100"></div>
			<div class="col-md-3 mt-5 offset-md-1">
				<div style="margin-top:10px;"><h2><b>연락처</b></h2></div>
